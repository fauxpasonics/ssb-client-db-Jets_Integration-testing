...
AND  a.[SSB_CRMSYSTEM_CONTACT_ID] IN (SELECT SSB_CRMSYSTEM_CONTACT_ID FROM DBO.vwCRMProcess_DistinctContacts_CriteriaMet)
...
FOR XML PATH('')), 1, 3, '' ),8000) as DimCustID_LoserString
--INTO #tmpA
